...
class CreateAnnouncementComponent {
    constructor(fb, activeModal, userService) {
        this.fb = fb;
...
class AnnouncmentComponent {
    constructor(modalService, announcementService, userService, http) {
    ...
    getAnnouncement() {
        this.userService.userInfo$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(({ id }) => this.announcementService.getOne(id))).subscribe(announcement => this.announcements = announcement);
    }
    createAnnouncement() {
        ...
        modalRef.closed.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(announcement => this.http.post('announcement/create', announcement))).subscribe(() => this.getAnnouncement());
    }
}
