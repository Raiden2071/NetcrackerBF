...
function CreateQuizTitleComponent_option_13_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", exampleQuiz_r1.key, " ");
} }
class CreateQuizTitleComponent {
    constructor(fb, router) {
        ...
        this.createQuizForm = this.fb.group({
            ...
            quizType: [this.quizTypes.history, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required]],
